...
console.info("alt-routing module init : area");

export default class Area extends HTMLAreaElement
{
    #_locationMatch;
    ...
    #connectionEventListener = (e) => 
    {
        ...
        if(config.area.dataAttribute.state)
        {
...
customElements.define(namings.components.area, Area, { extends: "area" });
